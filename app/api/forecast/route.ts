...
const LOCATIONS = [
  { id: "phl", name: "Philadelphia", state: "PA", lat: 39.9526, lon: -75.1652, x: 50, y: 79 },
  { id: "abe", name: "Allentown", state: "PA", lat: 40.6023, lon: -75.4714, x: 35, y: 106 },
  { id: "rdg", name: "Reading", state: "PA", lat: 40.3356, lon: -75.9269, x: 21, y: 92 },
  { id: "mpo", name: "Mt Pocono", state: "PA", lat: 41.122, lon: -75.3646, x: 35, y: 130 },
  { id: "sus", name: "Sussex", state: "NJ", lat: 41.2098, lon: -74.6077, x: 60, y: 138 },
  { id: "mmu", name: "Morristown", state: "NJ", lat: 40.7968, lon: -74.4815, x: 67, y: 120 },
  { id: "smq", name: "Somerville", state: "NJ", lat: 40.5743, lon: -74.6099, x: 65, y: 110 },
  { id: "ttn", name: "Trenton", state: "NJ", lat: 40.2171, lon: -74.7429, x: 62, y: 93 },
  { id: "lgb", name: "Long Branch", state: "NJ", lat: 40.3043, lon: -73.9924, x: 88, y: 101 },
  { id: "tom", name: "Toms River", state: "NJ", lat: 39.9537, lon: -74.1979, x: 83, y: 84 },
  { id: "ilg", name: "Wilmington", state: "DE", lat: 39.7447, lon: -75.5484, x: 38, y: 67 },
  { id: "vin", name: "Vineland", state: "NJ", lat: 39.4862, lon: -75.0257, x: 58, y: 59 },
  { id: "dov", name: "Dover", state: "DE", lat: 39.1582, lon: -75.5244, x: 42, y: 41 },
  { id: "acy", name: "Atlantic City", state: "NJ", lat: 39.3643, lon: -74.4229, x: 79, y: 56 },
  { id: "cap", name: "Cape May", state: "NJ", lat: 38.9351, lon: -74.906, x: 65, y: 35 },
  { id: "bet", name: "Bethany Beach", state: "DE", lat: 38.5396, lon: -75.0552, x: 63, y: 16 },
  { id: "eas", name: "Easton", state: "MD", lat: 38.7743, lon: -76.0763, x: 26, y: 21 },
] as const;
...
async function fetchLocation(location: (typeof LOCATIONS)[number], dates: string[]) {
  ...
  return {
    point: { id: location.id, name: location.name, state: location.state, lat: location.lat, lon: location.lon, values: dates.map((date) => grouped.has(date) ? Math.round(Math.max(...grouped.get(date)!)) : null) },
